...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p adb6f4fb-3718-4722-b216-e0d3a57f84a7
```

> `adb6f4fb-3718-4722-b216-e0d3a57f84a7` is the password of the certificate, you can change it to any password you want.
